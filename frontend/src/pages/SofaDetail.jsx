    ...
    <div className="max-w-[1200px] mx-auto px-6 py-16 select-none bg-[#FAF8F5]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20 items-start">
        ...
        <div className="lg:col-span-6 flex flex-col justify-start">
          ...
          {/* Quality Standards & Custom Assembly */}
          <div className="mt-6 pt-6 border-t border-[#EADFC9]/30">
            <h4 className="text-[10px] font-bold text-[#2A211D] uppercase tracking-wider mb-4">Quality & Craftsmanship Standards</h4>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3 bg-white p-3.5 border border-[#EADFC9]/40">
                <span className="text-xl">🪵</span>
                <div>
                  <span className="block text-xs font-bold text-[#2A211D]">Sal Wood Frame</span>
                  <span className="block text-[10px] text-[#8E7D75]">Seasoned Termite-free Timber</span>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white p-3.5 border border-[#EADFC9]/40">
                <span className="text-xl">🧽</span>
                <div>
                  <span className="block text-xs font-bold text-[#2A211D]">40 Density Foam</span>
                  <span className="block text-[10px] text-[#8E7D75]">Sag-resistant High Resilience</span>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white p-3.5 border border-[#EADFC9]/40">
                <span className="text-xl">🧵</span>
                <div>
                  <span className="block text-xs font-bold text-[#2A211D]">Custom Fabric</span>
                  <span className="block text-[10px] text-[#8E7D75]">Over 200+ Color Swatches</span>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white p-3.5 border border-[#EADFC9]/40">
                <span className="text-xl">🏭</span>
      ...
      <section className="border-t border-[#EADFC9]/40 pt-16" id="visualizer-target">
        <div className="text-center max-w-[600px] mx-auto mb-12 animate-fade-in">
          ...
          <h2 className="text-3xl font-serif font-bold text-[#2A211D] mb-4">Customize Sofa Configurations</h2>
